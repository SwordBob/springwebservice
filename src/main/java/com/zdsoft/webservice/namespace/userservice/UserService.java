 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://webservice.zdsoft.com/namespace/userservice", wsdlLocation = "http://localhost:8080/springwebservice/service/UserService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://webservice.zdsoft.com/namespace/userservice", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/springwebservice/service/UserService.wsdl");
    ...
    public IUserService getUserServicePort() {
        return super.getPort(new QName("http://webservice.zdsoft.com/namespace/userservice", "userServicePort"), IUserService.class);
    }
    ...
    public IUserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.zdsoft.com/namespace/userservice", "userServicePort"), IUserService.class, features);
    }
